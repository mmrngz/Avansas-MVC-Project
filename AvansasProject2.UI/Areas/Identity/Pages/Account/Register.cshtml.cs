...
namespace AvansasProject2.UI.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                RoleList = _roleManager.Roles.Where(i => i.Name != Other.Role_Birey).Select(x => x.Name).Select(u => new SelectListItem
                {
                    Text = u, 
                    Value = u 
                })
